...
namespace lab2
{
    static class TestExeption
    {
        static public void test()
        {
            Picture picture = new Picture(new ColoredLine(0, 0, 1, 1, Color.FromArgb(0, 255, 0, 0)),
                new ColoredPoint(2, 2, Color.FromArgb(0, 0, 255, 0)), new Line(4, 4, 5, 5),
            ...
            if (picture.Equals(picture2))
				Console.WriteLine("picture1 equal picture2");
            if (coloredPoint == (new ColoredPoint(2, 2, Color.FromArgb(0, 0, 255, 0))))
                Console.WriteLine("coloredPoint equal (new ColoredPoint(2, 2, Color.FromArgb(0, 0, 255, 0)))");

            ColoredPoint coloredPoint2 = new ColoredPoint(2, 1, Color.FromArgb(0, 0, 255, 0));
            if (!(coloredLine != picture.get(0)))
				Console.WriteLine("coloredLine equal picture.get(0)");
            if (!(coloredPoint != picture.get(1)))
				Console.WriteLine("coloredPoint equal picture.get(1)");
            if (!(line != picture.get(2)))
				Console.WriteLine("line equal picture.get(2)");
            if (!(polyLine != picture.get(3)))
				Console.WriteLine("polyLine equal picture.get(3)");
            if (!(picture2 != picture))
				Console.WriteLine("picture2 equal picture");
            ...
            Console.WriteLine("After making a deep copies we compare them with originals:");
